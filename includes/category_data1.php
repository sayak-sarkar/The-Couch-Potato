...
<tr>
	<div align="justify">
		...
		//	if($row[10]){echo"<span class='style1'><img src=posters/".$row[10]."/></span>";}
			...
			//if($row[10]) {echo"<li><span class='style1'><b>alt text: </b>".$row[10]."</span><br/><br/></li>";}
			if($row[11]) {echo"<li><span class='style1'><b>Summary: </b>".$row[11]."</span><br/><br/></li>";}
		}
		echo"</ul>";
				
		echo"<br/><span class='style1'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='../content_display.php?cat=admin'>Return To Previous 			Page""</a></span>"
		?>
		</span>	
	</div>
</tr>
